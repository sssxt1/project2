...
<div class="top">
    ...
    <div class="box2">
        ...
        <ul class="icon">
            <li><img src="/images/homePage/top/socks.png" alt="袜子" class="socks"><a href="socks.jsp" class="socks">袜子</a></li>
            <li><img src="/images/homePage/top/shoes.png" alt="男鞋" class="shoes"><a href="" class="shoes">男鞋</a></li>
            <li><img src="/images/homePage/top/high_shoes.png" alt="女鞋" class="high_shoes"><a href="" class="snack">女鞋</a></li>
            <li><img src="/images/homePage/top/medicine.png" alt="医药" class="medicine"><a href="" class="high_shoes">医药</a></li>
            <li><img src="/images/homePage/top/juice.png" alt="饮料" class="juice"><a href="" class="medicine">饮料</a></li>
            <li><img src="/images/homePage/top/fruit.png" alt="水果" class="fruit"><a href="" class="juice">水果</a></li>
            <li><img src="/images/homePage/top/snack.png" alt="零食" class="snack"><a href="" class="fruit">零食</a></li>
        </ul>
    </div>
</div>
<div class="middle">
