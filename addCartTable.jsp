...
<div class="content">
    <div class="left">
        <img class="bImg" src="/images/addCartTable/1.jpg" alt=""><br>
        <img class="small 1img" src="/images/addCartTable/1.jpg" alt="">
        <img class="small 2img" src="/images/addCartTable/2.jpg" alt="">
        <img class="small 3img" src="/images/addCartTable/3.jpg" alt="">
        <img class="small 4img" src="/images/addCartTable/4.jpg" alt="">
        <img class="small 5img" src="/images/addCartTable/5.jpg" alt="">
    </div>
    <div class="right">
        <p>Adidas阿迪达斯跑鞋男鞋2015秋冬运动鞋缓震跑步鞋B 23162 23163</p>
        <div class="price">
            <span>价格:</span>
        ...
        <div class="number">
            <span>数量</span>
            <span class="delete">-</span>
            <span><input type="text" value="2" class="number"></span>
            <span class="plus">+</span>
        </div>
        <div class="buy">
    ...
    <div class="center">
        ...
        <p class="content">产品名称：Adidas/阿迪达斯 2015Q2S</br>
            是否商场同款: 是</br>
